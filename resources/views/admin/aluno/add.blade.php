      ...
      <div class="row justify-content-center align-self-center">
        <div class="col-md-6 intro-info order-md-first order-last">
            <div class="form">
              ...
              <p></p>
              <form action="/admin/{{ session()->get('authAdmin')->nivel_acesso }}/{{ session()->get('authAdmin')->id }}/aluno/add" method="post">
                ...
                <div class="form-group">
                  ...
                  <select class="drop-down" id="concurso" name="concurso">
                    <option value="" >Selecione a opção certa</option>
                    @foreach($concurso as $data)
                    <option value="{{$data->id_concurso}}" >{{ $data->desc_concurso }}</option>
                    @endforeach
                  </select>
                  <div class="validation"></div>
                </div>
