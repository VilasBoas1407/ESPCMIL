          ...
          @if(session()->has('auth'))
            ...
            @elseif((session()->get('auth')->nivel_acesso) == 1)
              <li class="drop-down active"><a href="/admin/{{ session()->get('authAdmin')->nivel_acesso }}/{{ session()->get('authAdmin')->id }}">Painel</a>
                <ul>
                  <a href="/admin/{{ session()->get('authAdmin')->nivel_acesso }}/{{ session()->get('authAdmin')->id }}/professor/add">Adicionar Professor</a>
    ...
    <div class="container">
      <div class="row justify-content-center align-self-center">
        <div class="col-md-6 intro-info order-md-first order-last">
            <div class="form">
              <br>
              <h4>Cadastrar Concurso</h4>
              <p></p>
              <form action="/admin/{{ session()->get('authAdmin')->nivel_acesso }}/{{ session()->get('authAdmin')->id }}/concurso/add" method="post">
                <div class="form-group">
                  <label>Descrição Concurso</label>
                  <input type="text" name="desc" class="form-control" id="desc" placeholder="Guarda Civil" data-rule="minlen:4" data-msg="Campo inválido" />
