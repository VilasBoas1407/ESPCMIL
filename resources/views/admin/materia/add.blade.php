      ...
      <div class="row justify-content-center align-self-center">
        <div class="col-md-6 intro-info order-md-first order-last">
            <div class="form">
              ...
              <p></p>
              <form action="/admin/{{ session()->get('authAdmin')->nivel_acesso }}/{{ session()->get('authAdmin')->id }}/materia/add" method="post">
                <div class="form-group">
                  <label>Descrição Materia</label>
                  <input type="text" name="desc" class="form-control" id="desc" placeholder="Legislação..." data-rule="minlen:4" data-msg="Campo inválido" />
