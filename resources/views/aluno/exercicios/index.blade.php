        ...
        @foreach($materias as $materia)
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-duration="1.4s">
            <div class="box">
              ...
              <h4 class="title"><a href="/aluno/{{ session()->get('authUser')->nivel_acesso }}/{{ session()->get('authUser')->id }}/exercicios/{{ $materia['tb_concurso_id_concurso'] }}/{{ $materia['id_materia'] }}">{{$materia['desc_materia']}}</a></h4>
